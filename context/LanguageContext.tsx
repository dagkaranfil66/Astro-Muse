...
const translations = {
  tr: {
    ...
    services_list: {
      astroloji: { label: 'Astroloji', desc: 'Yapay Zeka Destekli · Gökyüzünün kadim işaretleri hayat yolunuzu aydınlatır' },
      kahve: { label: 'Kahve Falı', desc: 'Yapay Zeka Destekli · Türk kahvesi telveleri kaderin sırlarını fısıldar' },
      el: { label: 'El Falı', desc: 'Yapay Zeka Destekli · Avuç çizgilerinizde yazılı yaşam haritanızı okuyun' },
      tarot: { label: 'Tarot', desc: 'Yapay Zeka Destekli · Tengri yolundan ilham alan kartların gizemli mesajları' },
      samanizm: { label: 'Şamanizm Rehberliği', desc: 'Yapay Zeka Destekli · Ataların ruhlarıyla bağlantı kurarak yol bulun' },
      numeroloji: { label: 'Numeroloji', desc: 'Yapay Zeka Destekli · Sayıların gizli dili kaderin kapısını aralar' },
      ruh: { label: 'Ruh Okuma', desc: 'Yapay Zeka Destekli · Auranızı ve ruhsal enerjinizi derin biçimde okuyun' },
      dogum: { label: 'Doğum Haritası', desc: 'Yapay Zeka Destekli · Doğum anının yıldız haritasını okuyarak kaderinizi keşfedin' },
      ruya: { label: 'Rüya Yorumu', desc: 'Yapay Zeka Destekli · Rüyalarınızın gizli mesajlarını şamanist bilgelikle çözün' },
      burclar: { label: 'Burçlar', desc: 'Yapay Zeka Destekli · Burcunuza özel günlük mistik yorumlar ve rehberlik' },
      ask: { label: 'Aşk Uyumu', desc: 'Yapay Zeka Destekli · Burç uyumu ile ruhsal bağınızı ve aşk enerjinizi keşfedin' },
    },
    reading_meta: {
  ...
  en: {
    ...
    services_list: {
      astroloji: { label: 'Astrology', desc: 'AI-Powered · Ancient signs of the heavens illuminate your life\'s path' },
      kahve: { label: 'Coffee Fortune', desc: 'AI-Powered · Turkish coffee grounds whisper the secrets of fate' },
      el: { label: 'Palm Reading', desc: 'AI-Powered · Read the life map written in the lines of your palm' },
      tarot: { label: 'Tarot', desc: "AI-Powered · Mysterious messages from cards inspired by Tengri's path" },
      samanizm: { label: 'Shamanism Guidance', desc: 'AI-Powered · Find your way by connecting with ancestral spirits' },
      numeroloji: { label: 'Numerology', desc: "AI-Powered · The secret language of numbers unlocks fate's door" },
      ruh: { label: 'Soul Reading', desc: 'AI-Powered · Deeply read your aura and spiritual energy' },
      dogum: { label: 'Birth Chart', desc: 'AI-Powered · Discover your destiny by reading the star map of your birth moment' },
      ruya: { label: 'Dream Interpretation', desc: 'AI-Powered · Decode the hidden messages of your dreams with shamanic wisdom' },
      burclar: { label: 'Zodiac Signs', desc: 'AI-Powered · Daily mystic insights and guidance for your zodiac sign' },
      ask: { label: 'Love Compatibility', desc: 'AI-Powered · Discover your spiritual bond and love energy through zodiac compatibility' },
    },
    reading_meta: {
