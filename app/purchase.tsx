...
const PKG_DISPLAY: Record<string, {
  ...
  "tengri_başlangıç": { gradient: ["#1A1A30", "#0D1526"], popular: false, gold: 20,  bonus: 0,  label: "Başlangıç Paketi", discount: 0,  desc: "5 okuma için yeterli",  descEn: "Good for 5 readings" },
...
export default function PurchaseScreen() {
  ...
  const ORDER = ["tengri_başlangıç", "tengri_premium", "tengri_standard", "tengri_vip"];
