...
function getSlides(lang: "tr" | "en") {
  ...
  return [
    ...
    },
    {
      ...
      subtitle: tr
        ? "Yapay zeka ile kişisel analizlerini keşfet.\nKahve, tarot ve diğer mistik alanlarda sana özel yorumlar oluşturulur."
        : "Discover your personal analyses with AI.\nCoffee, tarot and other mystic fields — all interpreted just for you.",
      detail: tr
        ? "✨ Kişisel analizler  •  Yapay zeka yorumları  •  Benzersiz sonuçlar"
        : "✨ Personal analyses  •  AI interpretations  •  Unique results",
      note: tr
        ? "Tüm analizler yapay zeka tarafından kullanıcı verilerine göre oluşturulur. Uygulamada hazır fal metinleri bulunmaz."
        : "All analyses are generated by AI based on user data. No pre-written fortune-telling texts exist in the app.",
      accent: "#9B6FBB",
            ...
            <View style={styles.textBlock}>
              ...
              {!!(slide as any).note && (
                <View style={styles.aiNoteBox}>
                  <Text style={[styles.aiNoteText, { fontFamily: "Lora_400Regular" }]}>{(slide as any).note}</Text>
                </View>
              )}
            </View>
          </>
...
const styles = StyleSheet.create({
  ...
  aiNoteBox: {
    marginTop: 16,
    borderWidth: 1,
    borderColor: "rgba(155,111,187,0.35)",
    backgroundColor: "rgba(155,111,187,0.08)",
    borderRadius: 12,
