...
function getSlides(lang: "tr" | "en") {
  ...
  return [
    ...
    },
    {
      ...
      title: tr ? "11 Mistik\nHizmet" : "11 Mystical\nServices",
      subtitle: tr
        ? "Yapay zekâ ile kişiselleştirilmiş yorumlar — her okuma dinamik olarak sana özel üretilir."
        : "AI-personalized interpretations — every reading is dynamically generated just for you.",
      detail: tr
    ...
    },
    {
      ...
      detail: tr
        ? "✨ Yapay Zekâ Destekli  •  Sana Özel Yorumlar\nHer okuma dinamik olarak üretilir  •  Yalnızca eğlence amaçlıdır"
        : "✨ AI Personalized Interpretation  •  Each reading is uniquely generated by AI\nFor entertainment purposes only",
      accent: Colors.gold,
    },
  ];
}
